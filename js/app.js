...
const showProducts = (products) => {
    ...
    for (const product of allProducts) {
        // fixed the error of products image
      ...
      <img class="product-image" src=${image}></img>
        ...
        <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn add-cart-btn">add to cart</button>
...
const addToCart = (id, price) => {
    ...
    // call updateTotal function to get total 
    updateTotal();
};
